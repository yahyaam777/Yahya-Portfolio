...
const quizData = [
    {
        ...
        options: ["HyperText Markup Language", "HyperTransfer Text Language", "HighText Machine Language", "HyperText Machine Learning"],
    ...
    },
    {
        ...
        options: ["Display a message box with a message", "Change the background color of the page", "Submit a form", "Create a list"],
        correctAnswer: "Display a message box with a message"
    }
];
